...
DATA_DICTIONARY = {
    ...
    "liu_source_raw": _field("The four Liu SOURCE cells in order, joined with pipes without changing cell text; blank for Table S3, which has no SOURCE columns.", "free text or blank", "Liu 2014"),
    "liu_table_row": _field("Supplementary table and physical workbook row.", "free text (S1:n or S3:n)", "Liu 2014"),
    ...
    "record_type": _field("Separates secretory machinery from predicted cargo.", "machinery_component | secretory_client", "generated"),
