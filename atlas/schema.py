...
DATA_DICTIONARY = {
    ...
    "record_type": _field("Retained as an explicit grain marker so machinery rows cannot be mistaken for or silently mixed with other biological record types.", "machinery_component", "generated"),
    "subsystem": _field("Primary pathway subsystem used for diagram placement.", " | ".join([*SUBSYSTEM_ORDER, "blank"]), "generated"),
    "subsystem_source": _field("Primary evidence route used for the subsystem; supporting evidence chains are recorded in subsystem_rationale.", "liu2014 | liu2014_description | yeast_scaffold | current_annotation | kegg_pathway | curated_liu_composite | aspergillus_homolog | unassigned", "generated"),
    ...
    "mapping_method": _field("Short identifier-resolution method: direct_locus_tag is an exact current tag match; cross_reference, sequence, and orthology name alternate resolution routes; ambiguous, split, and merged flag non-unique model changes; unresolved means no current record was selected.", "direct_locus_tag | cross_reference | sequence | orthology | ambiguous | split | merged | unresolved", "generated"),
